...
// ==========================================
// 🚨 UPDATE YOUR FRONTEND URL BELOW 🚨
// ==========================================
// Example: origin: 'https://neuralnode-club.vercel.app'
// VERY IMPORTANT: Do NOT put a slash (/) at the very end of the URL!
app.use(cors({
  origin: 'YOUR_LIVE_FRONTEND_URL_HERE' 
}));
